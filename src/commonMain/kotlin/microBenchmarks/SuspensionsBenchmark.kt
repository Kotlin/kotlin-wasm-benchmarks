...
open class SuspensionsBenchmark : ParametrizedDispatcherBase() {
    ...
    fun chainSuspensions() {
        ...
        check (deepCompletion == BENCHMARK_SIZE) { "deepCompletion=$deepCompletion" }
    }
    ...
    fun deepSuspensions() {
        ...
        check (deepSuspensionsCount == BENCHMARK_SIZE) { "deepSuspensionsCount=$deepSuspensionsCount" }
        check (deepReached == 1) { "deepReached=$deepReached" }
        check (deepCompletion == BENCHMARK_SIZE) { "deepCompletion=$deepCompletion" }
    }
    ...
    fun selfResumptions() {
        ...
        check (result == BENCHMARK_SIZE) { "result=$result" }
    }
